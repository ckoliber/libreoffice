...
# Install libreoffice
RUN wget https://downloadarchive.documentfoundation.org/libreoffice/old/$VERSION/deb/x86_64/LibreOffice_$VERSION_Linux_x86-64_deb.tar.gz -O /tmp/libre.tar.gz
